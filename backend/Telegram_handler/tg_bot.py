...
from backend.Database.qaza_stats import get_prayer_times, get_prayer_message, get_all_users
...
async def daily_prayer_times_updater():
    while True:
        ...
        users = get_all_users()  # ← you implement this
        ...
        for user in users:
            try:
                ...
                print(f"[DAILY] Failed for user {user_id}: {e}")
